...
class WeixinState:
    """Persistent state for WeChat channel, stored at <state_dir>/state.json"""

    def __init__(self, state_dir: Path | None = None) -> None:
        self._state_dir = state_dir or Path.home() / ".mocode" / "weixin"
        self.token: str = ""
        self.base_url: str = "https://ilinkai.weixin.qq.com"
        self.context_tokens: dict[str, str] = {}
        self.typing_tickets: dict[str, dict] = {}
